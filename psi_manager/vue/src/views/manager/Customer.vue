<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入客户名称查询" style="width: 200px" v-model="name"></el-input>
      <el-input placeholder="请输入客户电话查询" style="width: 200px; margin-left: 10px" v-model="phone"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="zipCode" label="客户邮编"></el-table-column>
    ...
    <el-dialog title="供应商信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="客户地址" prop="address">
          <el-input v-model="form.address" placeholder="客户地址"></el-input>
        </el-form-item>
        <el-form-item label="客户电话" prop="tel">
          <el-input v-model="form.tel" placeholder="客户电话"></el-input>
        </el-form-item>
        <el-form-item label="客户邮箱" prop="email">
          <el-input v-model="form.email" placeholder="客户邮箱"></el-input>
        </el-form-item>
        <el-form-item label="客户邮编" prop="zipCode">
          <el-input v-model="form.zipCode" placeholder="客户邮编"></el-input>
        </el-form-item>
